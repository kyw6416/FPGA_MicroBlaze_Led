...
//Command     : generate_target design_MicoBlaze_Led_wrapper.bd
//Design      : design_MicoBlaze_Led_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module design_MicoBlaze_Led_wrapper
   (LED_tri_io,
    reset,
    sys_clock,
    usb_uart_rxd,
  ...
  IOBUF LED_tri_iobuf_7
       (.I(LED_tri_o_7),
        ...
        .O(LED_tri_i_7),
        .T(LED_tri_t_7));
  design_MicoBlaze_Led design_MicoBlaze_Led_i
