...
HD_PWD='D:/FPGA/MicroBlaze_Led/MicroBlaze_Led.runs/design_MicoBlaze_Led_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_MicoBlaze_Led_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_MicoBlaze_Led_dlmb_bram_if_cntlr_0.tcl
