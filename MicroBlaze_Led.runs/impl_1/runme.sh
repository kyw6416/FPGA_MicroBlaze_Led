...
HD_PWD='D:/FPGA/MicroBlaze_Led/MicroBlaze_Led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_MicoBlaze_Led_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_MicoBlaze_Led_wrapper.tcl -notrace
